...
if [ -f $srcdir/utt2warp ]; then
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/utt2warp >$destdir/utt2warp
fi
...
for f in feats.scp cmvn.scp vad.scp utt2lang utt2uniq utt2warp utt2dur utt2num_frames text wav.scp reco2file_and_channel frame_shift stm glm ctm; do
